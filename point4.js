var world = ["zero", "first", "last"]; var zones = world[Math.floor(Math.random() * world.length)];
...
$.getJSON(Base64.decode("Ly9wb3J0YWwycmVhbG0uaW1nbGUueHl6L2RhdGEv")+idcode.toUpperCase()+".json", function(data) {
  for (var i = 0; i < data.token.length; i++) {
	...
	var imgads = $("<img>").attr("src", "//blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiy4doNPCG16213ikdeLa2v4mkzkA7WYUi7SsTLxl48WJ0JMTuLs01CaewyuH7O2lAf1eh_dQQi4fRkSxQp0rlKmeVEtxvkujUZ9SJVm-OAa9T1E51y5wfdIWWToxglDjHXCRpqksPLpuFMNvqfwkHsev61wJIo8ewDIcSFuX6Xh9u9N7HmF23e5bm1NQ/s320-rw/720x90.jpg"); linkad.append(imgads);
	//insta  
